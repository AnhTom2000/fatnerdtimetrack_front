<template>
  <header class="schedule-calendar-hd">
    <button type="button" class="schedule-calendar-arrow double-arrow" @click="prevYear">&lt;&lt;</button>
    <button type="button" class="schedule-calendar-arrow" @click="prevMonth">&lt;</button>
    ...
    <button type="button" class="schedule-calendar-arrow" @click="nextMonth">&gt;</button>
    <button type="button" class="schedule-calendar-arrow double-arrow" @click="nextYear">&gt;&gt;</button>
  </header>
</template>
<script>
import { calcPrevMonth, calcNextMonth } from "./utils";
import picker from "./picker";
// import ntEvent from "../Ft-nTimeEv-carrd";
export default {
  components: {
    picker,
  },
